We are delighted to present the first release candidate for Contour v1.20.0, our layer 7 HTTP reverse proxy for Kubernetes clusters.
...
The simplest way to install v1.20.0-rc.1 is to apply one of the example configurations:

With Gateway API:
```bash
kubectl apply -f https://github.com/projectcontour/contour/blob/v1.20.0-rc.1/examples/render/contour-gateway.yaml
```

Without Gateway API:
```bash
kubectl apply -f https://github.com/projectcontour/contour/blob/v1.20.0-rc.1/examples/render/contour.yaml
```

## Compatible Kubernetes Versions

Contour v1.20.0-rc.1 is tested against Kubernetes 1.20 through 1.22

## Documentation

Documentation corresponding to `v1.20.0-rc.1` can be found at https://projectcontour.io/docs/main/.
