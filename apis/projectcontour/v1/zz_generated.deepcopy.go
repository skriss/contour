...
func (in *GlobalRateLimitPolicy) DeepCopyInto(out *GlobalRateLimitPolicy) {
	*out = *in
	if in.RateLimitDescriptors != nil {
		in, out := &in.RateLimitDescriptors, &out.RateLimitDescriptors
...
func (in *RateLimitDescriptor) DeepCopyInto(out *RateLimitDescriptor) {
	*out = *in
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]RateLimitDescriptorItem, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RateLimitDescriptorItem) DeepCopyInto(out *RateLimitDescriptorItem) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RateLimitDescriptorItem.
func (in *RateLimitDescriptorItem) DeepCopy() *RateLimitDescriptorItem {
	if in == nil {
		return nil
	}
	out := new(RateLimitDescriptorItem)
	in.DeepCopyInto(out)
	return out
}
